                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab2">
                            <div class="span12 well" style="padding: 1%; margin-left: 0">
                                ...
                                <div class="span11">
                                    <form id="formDesconto" action="<?php echo base_url(); ?>index.php/compras/adicionarDesconto" method="POST">
                                        <div class="span1">
                                            <input type="hidden" name="idCompras" id="idCompras" value="<?php echo $result->idCompras; ?>" />
