        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <ul style="flex-direction: row;" class="site-stats">
                    <li><a target="_blank" href="<?php echo base_url() ?>index.php/relatorios/comprasRapid"><i class="fas fa-cash-register"></i> <small>Todas as Compras - pdf</small></a></li>
                    <li><a target="_blank" href="<?php echo base_url() ?>index.php/relatorios/comprasRapid?format=xls"><i class="fas fa-cash-register"></i> <small>Todas as Compras - xls</small></a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                <div class="span12 well">
                    <form target="_blank" action="<?php echo base_url() ?>index.php/relatorios/comprasCustom" method="get">
                        <div class="span12 well">
                            <div class="span6">
